...
**Documented**: wheel **130 mm** (creator-confirmed; ~133.6 mm printed incl. tread); body envelope ≈ 690 × 670 × 553 mm, deck plate ≈ 515 × 384 × 204 mm (the old 140 mm-era 743×722×596 / 555×413×220 rescaled ×130/140 — **confirm off the in-repo DIY CAD**); ground clearance ~180 mm; what each module contains. *(The CG/sizing figures below were computed at the 140 mm scale — the verdict [low, centered CG; tip ≫ slope] still holds; re-verify the magnitudes at 130 mm.)*
...
- ✅ **Drivetrain breakout** — done: 21 named objects; those wheelbase 603 / track 567-632 / wheel 140 mm figures were at the **140 mm Blender scale** — the build uses the **130 mm** DIY CAD (wheelbase ≈560, track ≈526/587 mm; confirm off the in-repo DIY CAD). **Rebuild markup sent** to Blender (functional wheels / common corner knuckle for 37D + DS3218 / middle motor brackets / structural arms + cable channels / functional diff-bar).
